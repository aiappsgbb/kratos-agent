...
@description('Enable the capability host for agent conversations. In the refreshed preview (April 2026+), the platform creates capability hosts automatically — set to false (default). Only set to true for legacy (initial preview) deployments.')
